...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 28625 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 1775 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 26208 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 7397 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 6737 };
      job.tasks = [task];
      const employee: IEmployee = { id: 13785 };
      job.employee = employee;
