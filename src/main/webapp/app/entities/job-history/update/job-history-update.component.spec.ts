...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 13063 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 4370 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 18544 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 18422 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 6889 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 4890 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 1038 };
      jobHistory.job = job;
      const department: IDepartment = { id: 6716 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 28092 };
      jobHistory.employee = employee;
